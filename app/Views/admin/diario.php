    ...
    <div class="row d-flex align-items-center justify-content-center">
        <main class="col-12 col-lg-10 p-0 ">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-start pt-5 pb-2 px-5 mb-5 border-bottom bg-grad text-white">
                <h1 class="h2 n-color"><i class="fas fa-user pe-3"></i>Administrar Citas Diarias</h1>
            ...
            <form id="formCitaEdit" action="<?php echo site_url('AdminCitas/editCita'); ?>" method="post">
                <div class="modal-body">
                    <fieldset class="mb-4 d-flex flex-row flex-wrap justify-content-between px-0 px-md-2">
                        ...
                        <div class="col-12 col-md-6 my-2 px-4">
                            <label for="inputRutEdit" class="n-color">RUT</label>
                            <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">
                            <i class="fa-solid fa-chevron-right n-color"></i>
                        </span>
                                <input type="text" class="form-control" id="inputRutEdit">
                            </div>
                        </div>
                        ...
                        <span class="input-group-text" id="basic-addon1">
                            <i class="fa-solid fa-chevron-right n-color"></i>
                                ...
                                <input type="text" class="form-control" id="inputFonoEdit">
                            </div>
                        </div>
                        ...
                        <span class="input-group-text" id="basic-addon1">
                            <i class="fa-solid fa-chevron-right n-color"></i>
                                ...
                                <input type="number" class="form-control" id="inputEdadEdit">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 my-2 px-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select id="inputSexoEdit" class="form-select" aria-label="Default select example">
                                    <option value="" disabled="disabled" selected>Seleccione...</option>
                                    <option value="1">Masculino</option>
                                    <option value="2">Femenino</option>
                                </select>
                        ...
                        <span class="input-group-text" id="basic-addon1">
                            <i class="fa-solid fa-chevron-right n-color"></i>
                                ...
                                <input type="text" class="form-control" id="inputDireccionEdit">
                            </div>
                        </div>
...
<script type="text/javascript" src="<?php echo base_url() ?>/assets/views/js/admin-diario.js"></script>
</body>
</html>