    ...
    <div class="row ">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 p-0 ">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-start pt-4 pb-2 px-4 mb-3 border-bottom bg-grad text-white page-board">
                ...
                <h1 class="h2"><i class="fas fa-box pe-3"></i>Unidades</h1>
            ...
            <div class="row my-0 mx-3 border bg-light pt-4 table-container rounded-2">
                <form id="formGetUnidades" action="<?php echo site_url('AdminUnidades/getUnidades'); ?>"></form>
                ...
                <div class="container-fluid d-flex justify-content-end mt-3 mb-4">
                    <button id="btnEdit" class="btn btn-warning d-none rounded-pill">Modificar Unidad
    ...
    <div class="modal-dialog modal-md-" >
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="modalUnidadLabel">Agregar Nueva Unidad</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
            <form id="formUnidad" action="<?php echo site_url('AdminUnidades/addUnidad'); ?>" method="post">
...
<div class="modal fade" id="modalUnidadEdit" tabindex="-1" aria-labelledby="modalUnidadEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="modalUnidadEditLabel">Modificar Unidad</h5>
                <button type="button" class="btn-close btn-close-white text-white white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
            <form id="formUnidadEdit" action="<?php echo site_url('AdminUnidades/editUnidad'); ?>" method="post">
                <div class="modal-body">
...
<script type="text/javascript" src="<?php echo base_url() ?>/assets/views/js/admin-unidades.js"></script>
</body>
</html>