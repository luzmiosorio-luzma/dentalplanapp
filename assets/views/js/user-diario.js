...
$(document).ready(function (e) {
    ...
    tableTareas = $('#table_tareas').DataTable({
        ...
        columns: [
            ...
            // 'estado' NO se escapa: mismo endpoint que admin-diario.js
            // (AdminDiario/getUserCitas -> CitaModel::selectUserCitasFecha()),
            // devuelve un badge HTML real, no texto de usuario.
            {data: 'estado'},
...
$('#btnTarea').click(function (e) {
    ...
    if (usuario && fecha) {
        ...
        sendToast('sec', 'Datos', 'Debe Seleccionar una Fecha')
    }
});
